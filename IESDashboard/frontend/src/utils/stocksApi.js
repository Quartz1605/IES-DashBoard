...
export function generatePriceHistory(days = 30, startPrice = 100, volatility = 2) {
...
export function useStockData(initialData, updateInterval = 5000) {
...
export function useMarketIndices(initialData, updateInterval = 8000) {
...
export function useCurrencyPairs(initialData, updateInterval = 10000) {
...
export function useCryptoData(initialData, updateInterval = 7000) {
  const [cryptos, setCryptos] = useState(initialData);
